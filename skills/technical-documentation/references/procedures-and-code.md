...
- **F1 qualifies P1 (fork addition — not upstream text).** One *action* per step, not one clause. A step may open on a lead-in clause naming the reader's situation before the imperative: "When you get stuck, ask the tutor:" is still one action. See SKILL.md, Core Principle.
