...
| [`fito-guide-maintenance`](skills/fito-guide-maintenance/) | Explicitly bootstraps or synchronizes Fito's bilingual guide from its feature inventory, including translation and command-reference drift. Author-side tooling only; it never ships in `tui/`. | [SETUP.md](skills/fito-guide-maintenance/SETUP.md) |
